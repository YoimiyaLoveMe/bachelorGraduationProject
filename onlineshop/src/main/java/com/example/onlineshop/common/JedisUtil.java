 ...
 * 1 : 订单分类 orderid:* - category/combination
 * 1 : 用户心愿单（收藏） set (key-member): wish:customerid:* - *(goodsid) (差集推荐关联商品)
 ...
 * 2 : 出库单id分配 string (key-value) : warehouseoutid - * (incr)
 * 2 : 出库待发货集合 set (key-member) : outtoout - * (warehouseoutid)
 * 3 : 算法空间
